...
echo "--------> Starting hyperledger PEER2 <-----------"

docker run  -d --name=PEER2 -it \
                ...
                -e CORE_SECURITY_ENROLLSECRET=vQelbRvja7cJ rameshthoomu/peer:adc1600 peer node start
